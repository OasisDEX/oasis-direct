    ...
    return (
      <section className="frame finalize">
        ...
        <div className="info-box">
          <div className="info-box-row">
            <span className="holder">
              ...
              <TokenAmount number={toWei(this.props.system.trade.price)}
        ...
        <div className="content">
          {
            ...
            <a
              href={typeof this.props.transactions.proxy !== 'undefined' && this.props.transactions.proxy.tx ? `${etherscanUrl(this.props.network.network)}/tx/${this.props.transactions.proxy.tx}` : '#'}
          ...
          }
          {
            ...
            <a
              href={typeof this.props.transactions.approval !== 'undefined' && this.props.transactions.approval.tx ? `${etherscanUrl(this.props.network.network)}/tx/${this.props.transactions.approval.tx}` : '#'}
              ...
              <div className="transaction-info-box">
                <div className="operation">
                  ...
                  </span>
                  {
                    typeof this.props.transactions.approval === 'undefined'
                      ?
                      this.props.system.trade.txs <= 2 || (/*typeof this.props.transactions.proxy.pending !== 'undefined' && */this.props.transactions.proxy.pending === false && this.props.transactions.proxy.error === false)
                        ?
                        <React.Fragment>
          ...
          }
          {
            !this.hasTxCompleted('trade')
              ...
              :
              <a
                href={typeof this.props.transactions.trade !== 'undefined' && this.props.transactions.trade.tx ? `${etherscanUrl(this.props.network.network)}/tx/${this.props.transactions.trade.tx}` : '#'}
                  ...
                  <div className="operation">
                    <div className="details">
                      ...
                      <span className="value">{this.props.system.trade.operation === 'sellAll' ? '' : '~ '}
                        <TokenAmount number={toWei((this.props.system.trade.amountPay.valueOf()))}
                                     token={tokens[this.props.system.trade.from].symbol}/>
                    </span>
                      {
        ...
        <button type="submit" value="Trade again"
                onClick={this.props.system.reset}
