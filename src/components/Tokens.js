...
export class Ether extends PureComponent {
  render() {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" className="ether">
        <path
...
export class MKR extends PureComponent {
  render() {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" className="MakerToken">
        <path fill="#3AB493"
        ...
        <g id='Page-1' fill='none' fillRule='evenodd'>
          <g id='Group'>
            <path d='M11,0.5 C5.2,0.5 0.5,5.2 0.5,11 C0.5,16.8 5.2,21.5 11,21.5 C16.8,21.5 21.5,16.8 21.5,11 C21.5,5.2 16.8,0.5 11,0.5 Z'
                  id='Shape' strokeOpacity='.75' stroke='#000' strokeWidth='.917' />
            <g id='icon' transform='translate(5 5)'>
              <rect id='Rectangle' fill='#F7A600' transform='rotate(45 5.997 6.005)'
                    x='1.748' y='1.804' width='8.497' height='8.402' />
              <polygon id='Rectangle-Copy' fillOpacity='.75' fill='#F7A600' transform='rotate(45 5.997 6.005)'
                       points='1.74816175 1.8036323 10.245396 1.8036323 7.49889187 7.4901065 1.74816175 10.2059225'
              />
              <g id='Combined-Shape'>
                <use fill='#F7A600' filter='url(#filter-2)' xlinkHref='#path-1' />
