...
export class Logo extends PureComponent {
  render() {
    return (
      <svg id="Layer_1" width="216" height="42" viewBox="0 0 999.24 216">
        <path d="M391.84,0H915a20,20,0,0,1,16.12,8.19l64.27,88h0a20,20,0,0,1,0,23.54l-64.27,88h0A20,20,0,0,1,915,216H391.84a8,8,0,0,1-6.48-12.65l60.31-83.68h0a20,20,0,0,0,0-23.34L385.37,12.65h0A8,8,0,0,1,391.84,0Z" fill="white"/>
        <path d="M821.79,109,840.44,97.4a39,39,0,1,0,.4,40.54L822,126.69a17,17,0,1,1-.17-17.67Zm33.49-25V71l22-7V84h15v21h-15v28q0,5.12,6.67,5h8.3v19H872.94q-17.65-2.78-17.65-21V105h-11V83ZM722.56,157a39,39,0,0,1,0-78c21.5,0,37.92,15.42,37.92,39v9H706.59q4.37,8.73,15,10a20.78,20.78,0,0,0,18-6l18,11C751.6,150.14,741.21,157,722.56,157Zm16-47c0-6.33-7.15-12-16-12s-16,5.67-16,12ZM635.73,83h22V95q3.87-12,22-13v25c-10.88-1.72-22,3.66-22,14v36h-22ZM600.8,83h22v74h-22Zm11-6a13,13,0,1,1,13-13A13,13,0,0,1,611.78,77Zm-71.86,80H500V53h39.92c28.66,0,50.9,23.28,50.9,52S568.58,157,539.92,157Zm.42-22.86c16.06,0,28.53-9.94,28.53-29.14S556.4,75.86,540.34,75.86H523v58.29Z" fill="#3F51B5"/>
        <path d="M276,83h22v74H276Zm11-6a13,13,0,1,1,13-13A13,13,0,0,1,287,77ZM146.71,157c-19.29,0-34.93-17.68-34.93-39.5S127.42,78,146.71,78a33.2,33.2,0,0,1,23,9.45V80h21v77h-21v-7.16C163.6,155.56,155.22,157,146.71,157Zm5-21a18,18,0,1,0-18-18A18,18,0,0,0,151.7,136ZM51.9,157a52,52,0,1,1,51.9-52A51.95,51.95,0,0,1,51.9,157Zm0-22A30,30,0,1,0,22,105,30,30,0,0,0,51.9,135Zm259.48,7.5,11.18-13.7q12.33,10.77,21.76,10.7,8.78,0,8.78-8,0-6.06-12.77-7-26.65-5-26.65-25,2.69-23.71,28.64-23.8a45.64,45.64,0,0,1,29,10.2l-9.58,13.5q-11.5-6.15-19.46-6.6-9-.51-10,6.7,0,6,8,6.7,32.93,4,32.53,26.3c-.1,22-21.56,24.5-28.54,24.5S326.36,156,311.38,142.5Zm-109.78,0,11.18-13.7q12.33,10.77,21.76,10.7,8.78,0,8.78-8,0-6.06-12.77-7-26.65-5-26.65-25,2.69-23.71,28.64-23.8a45.64,45.64,0,0,1,29,10.2L252,99.4q-11.5-6.15-19.46-6.6-9-.51-10,6.7,0,6,8,6.7,32.93,4,32.53,26.3c-.1,22-21.56,24.5-28.54,24.5S216.57,156,201.6,142.5Z" fill="white"/>
      </svg>
    )
  }
}
