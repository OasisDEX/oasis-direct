...
class SetTrade extends React.Component {
  ...
  render() {
    return (
      <React.Fragment>
        {
          this.props.network.hasSwitched && <NetworkSwitchNotification onAck={this.props.network.ackNetworkSwitch} network={this.props.network.network}/>
        }
        {
                  ...
                  }
                  {
                    ...
                    (
                      this.props.system.trade.errorInputSell === "funds"
                        ?
                        <span
                          className="label"> You don't have enough <strong>{this.props.tokens[this.props.system.trade.from].name} </strong> in your Wallet</span>
                        :
