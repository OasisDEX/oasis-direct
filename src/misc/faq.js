...
const FAQ = [
  ...
  },
  {
    ...
    anwer: "The slippage limit value is used to create a Limit Order for your transaction. It ensures that the actual trade price does not differ substantially from the estimated trade price that was accepted by the user. If the order book changed significantly between estimating the price and the trade execution the order will not be filled. With Slippage Limit 2% OasisDirect will execute fill-or-kill Limit Order with the price limit set 2% above the accepted estimated trade price."
  },
  {
